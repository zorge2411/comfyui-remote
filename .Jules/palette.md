...
## 2026-06-15 - [Invisible Action Feedback]
**Learning:** Actions with invisible results (like "Copy to Clipboard") confuse users who are unsure if the action succeeded.
**Action:** Always provide explicit feedback (e.g., Toast, Snackbar) and use semantically correct icons (e.g., ContentCopy) for such actions.
