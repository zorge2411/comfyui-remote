...
## 2026-05-23 - [Status Indicators]
**Learning:** Relying solely on color for connection state (Green/Red/Yellow) is inaccessible for color-blind users and lacks semantic clarity.
**Action:** Always combine status colors with meaningful icons (e.g., Check, Sync, Error) and use subtle animations (rotation) for active states like "Connecting".
