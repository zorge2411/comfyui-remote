...
## 2024-10-27 - [Action Icon Semantics]
**Learning:** Using generic icons (like 'Info') for specific actions (like 'Copy') confuses users and lacks affordance.
**Action:** Use universally recognized icons (e.g., 'ContentCopy') and always provide feedback (e.g., Toast) for invisible actions.
