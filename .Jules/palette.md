...
## 2026-02-02 - [Copy Action Feedback]
**Learning:** Users are unsure if the "Copy" action succeeded because it is invisible. Also, using generic icons (Info) for Copy is confusing.
**Action:** Always use the standard `ContentCopy` icon and provide immediate feedback (e.g., Toast) for clipboard actions.
